module "prod-cropper-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "cropper.watch.aetnd.com"
  ...
  healthchecks = {
    "cropper-HC" = {
      host = "cropper.watch.aetnd.com"
    }
  }

  default_s3_logging      = {}
  default_datadog_logging = {}
  service_name_tag        = "prod-watch-cropper-service"
  ...
  tags = {
    "aetnd:service_name" = "prod-watch-cropper"
  }
}
