module "prod-lifetimetvstore-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "lifetimetvstore.com"

  domains = [
    "lifetimetvstore.com",
    "www.lifetimetvstore.com",
  ]
  ...
  snippets = {
    ...
    aetn_services_recv         = { type = "init", priority = 100, content = file("${path.module}/fastly/lifetimetvstore-com/aetn_services_recv.vcl") }
    aetn_default_backend       = { type = "init", priority = 100, content = file("${path.module}/fastly/lifetimetvstore-com/aetn_default_backend.vcl") }
    redirects                  = { type = "init", priority = 100, content = file("${path.module}/fastly/lifetimetvstore-com/redirects.vcl") }
    backends                   = { type = "init", priority = 100, content = file("${path.module}/fastly/lifetimetvstore-com/prod-backends.vcl") }
  }

  vcls = {
    main = {
      main    = true
      content = file("${path.module}/fastly/lifetimetvstore-com/default.vcl")
    }
  }
