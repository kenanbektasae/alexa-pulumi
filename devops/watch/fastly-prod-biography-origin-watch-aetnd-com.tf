module "prod-biography-origin-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "biography-origin.watch.aetnd.com"

  domains = [
    "biography-origin.watch.aetnd.com",
    "biography-origin-no-dns.watch.aetnd.com",
  ]
