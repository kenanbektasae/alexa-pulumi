module "qa-editorials-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "qa-editorials.watch.aetnd.com"

  domains = [
    "qa-editorials.watch.aetnd.com"
  ]
  ...
  snippets = {
    ...
    backend                           = { type = "init", priority = 100, content = file("${path.module}/fastly/editorials-watch-aetnd-com/qa_backend.vcl") }
