module "prod-mplclicense-history-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "mplclicense.history.com"

  domains = [
    "mplclicense.history.com",
  ]
  ...
  snippets = {
    ...
    backend                    = { type = "init", priority = 100, content = file("${path.module}/fastly/mplclicense-history-com/prod_backend.vcl") }
