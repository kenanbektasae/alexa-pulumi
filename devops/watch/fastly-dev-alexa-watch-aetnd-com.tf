module "dev-alexa-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "dev-alexa.watch.aetnd.com"

  domains = [
    "dev-alexa.watch.aetnd.com"
  ]

  backends = {
    TLS_Backend = {
      address     = "dev-watch-ingress.aetnd.io"
      healthcheck = "alexa-HC"
    }
  }

  healthchecks = {
    "alexa-HC" = {
      host = "dev-alexa.watch.aetnd.com"
    }
  }
  ...
  snippets = {
    ...
    aetn_services_recv         = { type = "init", priority = 100, content = file("${path.module}/fastly/alexa-watch-aetnd-com/aetn_services_recv.vcl") }
    aetn_default_backend       = { type = "init", priority = 100, content = file("${path.module}/fastly/alexa-watch-aetnd-com/aetn_default_backend.vcl") }
  }

  vcls = {
    main = {
      main    = true
      content = file("${path.module}/fastly/alexa-watch-aetnd-com/default.vcl")
    }
  }
  ...
  tags = {
    "aetnd:service_name" = "dev-watch-alexa"
  }
}
