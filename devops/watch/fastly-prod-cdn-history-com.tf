module "prod-cdn-history-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "cdn.history.com"
  ...
  snippets = {
    ...
    backend                    = { type = "init", priority = 100, content = file("${path.module}/fastly/cdn-history-com/prod_backend.vcl") }
