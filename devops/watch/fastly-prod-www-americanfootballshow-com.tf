module "prod-www-americanfootballshow-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "www.americanfootballshow.com"

  domains = [
    "www.americanfootballshow.com",
  ]
  ...
  snippets = {
    ...
    backends                   = { type = "init", priority = 100, content = file("${path.module}/fastly/www-americanfootballshow-com/prod_backend.vcl") }
  }
