module "qa-www-mylifetime-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "qa.mylifetime.com"

  domains = [
    "qa-captionsplash.mylifetime.com",
    "qa-downloads.mylifetime.com",
    "qa-ej.dance.mylifetime.com",
    "qa-fanfave.mylifetime.com",
    "qa-fashiongames.mylifetime.com",
    "qa-maids.mylifetime.com",
    "qa-moms.mylifetime.com",
    "qa-moviemashup.mylifetime.com",
    "qa-preview.mylifetime.com",
    "qa-shop.mylifetime.com",
    "qa.lifetimelive.com",
    "qa.mylifetime.com",
    "qa.shop.mylifetime.com",
  ]
