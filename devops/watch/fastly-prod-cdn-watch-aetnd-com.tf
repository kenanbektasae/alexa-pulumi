module "prod-cdn-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "cdn.watch.aetnd.com"
  ...
  snippets = {
    ...
    backend                    = { type = "init", priority = 100, content = file("${path.module}/fastly/cdn-watch-aetnd-com/prod_backend.vcl") }
  }
