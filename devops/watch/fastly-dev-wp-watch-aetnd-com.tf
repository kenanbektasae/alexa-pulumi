module "dev-wp-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "dev-wp.watch.aetnd.com"

  domains = [
    "dev-wp.watch.aetnd.com",
  ]
  ...
  tags = {
    "aetnd:service_name" = "dev-watch-wp"
  }
}
