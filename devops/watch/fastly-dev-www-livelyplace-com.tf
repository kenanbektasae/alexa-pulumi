module "dev-www-livelyplace-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "dev.livelyplace.com"
  ...
  snippets = {
    ...
    backends                   = { type = "init", priority = 100, content = file("${path.module}/fastly/www-livelyplace-com/dev_backend.vcl") }
  }
