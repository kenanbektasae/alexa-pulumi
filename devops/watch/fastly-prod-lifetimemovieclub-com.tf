module "prod-lifetimemovieclub-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "lifetimemovieclub.com"

  domains = [
    "www.lifetimemovieclub.com",
    "lifetimemovieclub.com",
    "preview.lifetimemovieclub.com",
  ]
  backends = {
  ...
  snippets = {
    ...
    aetn_service_cache_fetch            = { type = "init", priority = 100, content = file("${path.module}/fastly/lifetimemovieclub-com/aetn_service_cache_fetch.vcl") }
    ...
    aetn_service_eu_redirects           = { type = "init", priority = 100, content = file("${path.module}/fastly/lifetimemovieclub-com/aetn_service_eu_redirects.vcl") }
    ...
    aetn_webpay_proxypass               = { type = "init", priority = 100, content = file("${path.module}/fastly/lifetimemovieclub-com/aetn_webpay_proxypass.vcl") }
    aetn_services_recv                  = { type = "init", priority = 100, content = file("${path.module}/fastly/lifetimemovieclub-com/aetn_services_recv.vcl") }
    aetn_default_backend                = { type = "init", priority = 100, content = file("${path.module}/fastly/lifetimemovieclub-com/aetn_default_backend.vcl") }
    aetn_services_proxypass             = { type = "init", priority = 100, content = file("${path.module}/fastly/lifetimemovieclub-com/aetn_services_proxypass.vcl") }
    aetn_services_rewrites              = { type = "init", priority = 100, content = file("${path.module}/fastly/lifetimemovieclub-com/aetn_services_rewrites.vcl") }
    redirects                           = { type = "init", priority = 100, content = file("${path.module}/fastly/lifetimemovieclub-com/redirects.vcl") }
    vcl_error                           = { type = "init", priority = 100, content = file("${path.module}/fastly/lifetimemovieclub-com/vcl_error.vcl") }
  }

  vcls = {
    main = {
      main    = true
      content = file("${path.module}/fastly/lifetimemovieclub-com/default_sigsci.vcl")
    }
  }
