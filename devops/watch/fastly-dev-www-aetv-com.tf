module "dev-www-aetv-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "dev.aetv.com"

  domains = [
    "dev.aetv.com",
    "dev-preview.aetv.com",
    "dev-beardyourself.aetv.com",
    "dev-community.aetv.com",
    "dev-damien.aetv.com",
    "dev-robertsonfamily.aetv.com",
    "dev-shop.aetv.com",
    "dev.lookevencloser.com",
  ]
  ...
  snippets = {
    ...
    vcl_error                          = { type = "init", priority = 100, content = file("${path.module}/fastly/www-aetv-com/vcl_error.vcl") }
  }
