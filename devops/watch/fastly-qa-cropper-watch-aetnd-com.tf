module "qa-cropper-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "qa-cropper.watch.aetnd.com"

  domains = [
    "qa-cropper.watch.aetnd.com"
  ]
  ...
  backends = {
    TLS_Backend = {
      address     = "qa-watch-ingress.aetnd.io"
  ...
  healthchecks = {
    "cropper-HC" = {
      host = "qa-cropper.watch.aetnd.com"
    }
  }
  ...
  tags = {
    "aetnd:service_name" = "qa-watch-cropper"
  }
}
