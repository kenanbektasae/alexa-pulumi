module "qa-cdn-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "qa-cdn.watch.aetnd.com"

  domains = [
    "qa-cdn.watch.aetnd.com",
  ]
  ...
  snippets = {
    ...
    backend                    = { type = "init", priority = 100, content = file("${path.module}/fastly/cdn-watch-aetnd-com/qa_backend.vcl") }
  }
