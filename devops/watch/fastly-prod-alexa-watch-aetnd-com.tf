module "prod-alexa-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "alexa.watch.aetnd.com"

  domains = [
    "alexa.watch.aetnd.com"
  ]
  ...
  healthchecks = {
    "alexa-HC" = {
      host = "alexa.watch.aetnd.com"
    }
  }

  default_s3_logging      = {}
  default_datadog_logging = {}
  service_name_tag        = "prod-watch-alexa-service"
  ...
  tags = {
    "aetnd:service_name" = "prod-watch-alexa"
  }
}
