module "qa-cdn-history-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "qa-cdn.history.com"
  ...
  snippets = {
    ...
    backend                    = { type = "init", priority = 100, content = file("${path.module}/fastly/cdn-history-com/qa_backend.vcl") }
