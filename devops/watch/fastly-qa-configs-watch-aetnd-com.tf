module "qa-configs-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "qa-configs.watch.aetnd.com"

  domains = [
    "qa-configs.watch.aetnd.com"
  ]
  ...
  snippets = {
    ...
    backend                    = { type = "init", priority = 100, content = file("${path.module}/fastly/configs-watch-aetnd-com/qa_backend.vcl") }
  }
