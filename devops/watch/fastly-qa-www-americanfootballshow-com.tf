module "qa-www-americanfootballshow-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "qa.americanfootballshow.com"

  domains = [
    "qa.americanfootballshow.com",
  ]
  ...
  snippets = {
    ...
    backends                   = { type = "init", priority = 100, content = file("${path.module}/fastly/www-americanfootballshow-com/qa_backend.vcl") }
  }
