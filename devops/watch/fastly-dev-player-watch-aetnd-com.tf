module "dev-player-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "dev-player.watch.aetnd.com"

  domains = [
    "dev-player.watch.aetnd.com",
    "dev-player.aetndigital.com",
    "dev-player.aetv.com",
    "dev-player.biography.com",
    "dev-player.fyi.tv",
    "dev-player.history.com",
    "dev-player.mylifetime.com",
  ]
  ...
  snippets = {
    ...
    aetn_services_rewrites     = { type = "init", priority = 100, content = file("${path.module}/fastly/player-watch-aetnd-com/aetn_services_rewrites.vcl") }
    aetn_services_proxypass    = { type = "init", priority = 100, content = file("${path.module}/fastly/player-watch-aetnd-com/aetn_services_proxypass.vcl") }
    aetn_services_recv         = { type = "init", priority = 100, content = file("${path.module}/fastly/player-watch-aetnd-com/aetn_services_recv.vcl") }
    aetn_default_backend       = { type = "init", priority = 100, content = file("${path.module}/fastly/player-watch-aetnd-com/aetn_default_backend.vcl") }
    redirects                  = { type = "init", priority = 100, content = file("${path.module}/fastly/player-watch-aetnd-com/redirects.vcl") }
    backends                   = { type = "init", priority = 100, content = file("${path.module}/fastly/player-watch-aetnd-com/dev-backends.vcl") }
  }

  vcls = {
    main = {
      main    = true
      content = file("${path.module}/fastly/player-watch-aetnd-com/default.vcl")
    }
  }
