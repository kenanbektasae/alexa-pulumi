module "qa-player-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "qa-player.watch.aetnd.com"

  domains = [
    "qa-player.watch.aetnd.com",
    "qa-player.aetndigital.com",
    "qa-player.aetv.com",
    "qa-player.biography.com",
    "qa-player.fyi.tv",
    "qa-player.history.com",
    "qa-player.mylifetime.com",
  ]
  ...
  snippets = {
    ...
    backends                   = { type = "init", priority = 100, content = file("${path.module}/fastly/player-watch-aetnd-com/qa-backends.vcl") }
  }
