module "prod-configs-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "configs.watch.aetnd.com"

  domains = [
    "configs.watch.aetnd.com"
  ]
  ...
  snippets = {
    ...
    backend                    = { type = "init", priority = 100, content = file("${path.module}/fastly/configs-watch-aetnd-com/prod_backend.vcl") }
  }
