module "prod-www-crimeandinvestigationnetwork-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "www.crimeandinvestigationnetwork.com"

  domains = [
    "ci.tv",
    "crimeandinvestigationnetwork.com",
    "www.ci.tv",
    "www.crimeandinvestigationnetwork.com",
  ]
