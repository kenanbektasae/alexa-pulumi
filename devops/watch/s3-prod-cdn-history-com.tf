module "prod-cdn-history-com-s3" {
  source        = "./modules/s3/modules/s3"
  account_id    = "433624884903"
  region        = "us-east-1"
  bucket        = "prod-cdn-history-com"
  force_destroy = true
  grant = [{
    display_name = "devops"
  ...
  logging = {
    ...
    target_prefix = "prod-cdn-history-com/"
  }
  request_payer   = "BucketOwner"
  attach_policies = true
  bucket_policies = file("./policies/prod-cdn-history-com.yaml")
  ...
  tags = {
    ...
    "aetn:env"                   = "prod"
    "aetn:hostnames"             = "prod-cdn-history-com"
    ...
    hostnames                    = "prod-cdn-history-com"
  }
  versioning = {
    status = true
  }
...
//ultraDNS
resource "ultradns_record" "cname-cdn-history-com" {
  zone_name   = "history.com"
  record_type = "CNAME"
  owner_name  = "cdn.history.com."
  record_data = [
