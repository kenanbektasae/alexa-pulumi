module "prod-editorials-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "editorials.watch.aetnd.com"

  domains = [
    "editorials.watch.aetnd.com"
  ]
  ...
  snippets = {
    ...
    backend                             = { type = "init", priority = 100, content = file("${path.module}/fastly/editorials-watch-aetnd-com/prod_backend.vcl") }
