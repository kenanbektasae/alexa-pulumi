module "prod-www-livelyplace-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "www.livelyplace.com"
  ...
  snippets = {
    ...
    aetn_services_rewrites     = { type = "init", priority = 100, content = file("${path.module}/fastly/www-livelyplace-com/aetn_services_rewrites.vcl") }
    aetn_editorials_proxypass  = { type = "init", priority = 100, content = file("${path.module}/fastly/www-livelyplace-com/aetn_editorials_proxypass.vcl") }
    aetn_services_proxypass    = { type = "init", priority = 100, content = file("${path.module}/fastly/www-livelyplace-com/aetn_services_proxypass.vcl") }
    aetn_services_recv         = { type = "init", priority = 100, content = file("${path.module}/fastly/www-livelyplace-com/aetn_services_recv.vcl") }
    aetn_default_backend       = { type = "init", priority = 100, content = file("${path.module}/fastly/www-livelyplace-com/aetn_default_backend.vcl") }
    redirects                  = { type = "init", priority = 100, content = file("${path.module}/fastly/www-livelyplace-com/redirects.vcl") }
    backends                   = { type = "init", priority = 100, content = file("${path.module}/fastly/www-livelyplace-com/prod_backend.vcl") }
  }

  vcls = {
    main = {
      main    = true
      content = file("${path.module}/fastly/www-livelyplace-com/default.vcl")
    }
  }
