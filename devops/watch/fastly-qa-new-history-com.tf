module "qa-new-history-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "qa-new.history.com"
  ...
  backends = {
    ...
    activate_editorial_aenetworks_cloud = {
      ...
      share_key = "5CnyX7MKfliFFomDjmDAIUNq"
    }
  }
  ...
  snippets = {
    activate                              = { type = "init", priority = 1, content = file("${path.module}/fastly/new-history-com/activate.vcl") }
    loki                                  = { type = "init", priority = 5, content = file("${path.module}/fastly/new-history-com/loki.vcl") }
    ...
    aetn_cache_fetch                      = { type = "init", priority = 20, content = file("${path.module}/fastly/new-history-com/aetn_cache_fetch.vcl") }
    ...
    history-backends                      = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/history-backends.vcl") }
    customer_token                        = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/customer_token.vcl") }
    aetn_editorials_proxypass             = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/aetn_editorials_proxypass.vcl") }
    aetn_services_recv                    = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/aetn_services_recv.vcl") }
    aetn_default_backend                  = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/aetn_default_backend.vcl") }
    aetn_service_eu_redirects             = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/aetn_service_eu_redirects.vcl") }
    aetn_services_proxypass               = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/aetn_services_proxypass.vcl") }
    aetn_services_rewrites                = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/aetn_services_rewrites.vcl") }
    redirects                             = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/redirects.vcl") }
    baseauth                              = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/aetn_baseauth.vcl") }
    redirects-activate                    = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/redirects-activate.vcl") }
    redirects-arena1                      = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/redirects-arena-1.vcl") }
    redirects-arena2                      = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/redirects-arena-2.vcl") }
    vcl_error                             = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/vcl_error.vcl") }
  }

  vcls = {
    main = {
      main    = true
      content = file("${path.module}/fastly/new-history-com/default_sigsci.vcl")
    }
  }
