module "qa-mplclicense-history-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "qa-mplclicense.history.com"

  domains = [
    "qa-mplclicense.history.com",
  ]
  ...
  snippets = {
    ...
    backend                    = { type = "init", priority = 100, content = file("${path.module}/fastly/mplclicense-history-com/qa_backend.vcl") }
