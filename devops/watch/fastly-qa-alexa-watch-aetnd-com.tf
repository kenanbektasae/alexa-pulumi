module "qa-alexa-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "qa-alexa.watch.aetnd.com"

  domains = [
    "qa-alexa.watch.aetnd.com"
  ]
  ...
  tags = {
    "aetnd:service_name" = "qa-watch-alexa"
  }
}
