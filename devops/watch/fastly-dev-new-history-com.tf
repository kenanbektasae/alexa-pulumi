module "dev-new-history-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "dev-new.history.com"
  ...
  snippets = {
    ...
    redirects                              = { type = "init", priority = 100, content = file("${path.module}/fastly/new-history-com/redirects-dev.vcl") }
