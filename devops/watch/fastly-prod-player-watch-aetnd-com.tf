module "prod-player-watch-aetnd-com-fastly" {
  source = "./modules/fastly/vcl_service"

  service_name = "player.watch.aetnd.com"

  domains = [
    "player.watch.aetnd.com",
    "player.aetndigital.com",
    "player.aetv.com",
    "player.biography.com",
    "player.fyi.tv",
    "player.history.com",
  ...
  snippets = {
    ...
    backends                   = { type = "init", priority = 100, content = file("${path.module}/fastly/player-watch-aetnd-com/prod-backends.vcl") }
  }
